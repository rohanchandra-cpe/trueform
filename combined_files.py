...
while cap.isOpened():
    ...
    elif abs(180-shoulder_wrist) < 20:
        cv2.line(image_np, (parts[6][0], parts[6][1]), (parts[8][0], parts[8][1]), (0, 255, 255), 2)
        cv2.line(image_np, (parts[8][0], parts[8][1]), (parts[10][0], parts[10][1]), (0, 255, 255), 2)
    elif abs(180-shoulder_wrist) < 30:
        cv2.line(image_np, (parts[6][0], parts[6][1]), (parts[8][0], parts[8][1]), (0, 165, 255), 2)
        cv2.line(image_np, (parts[8][0], parts[8][1]), (parts[10][0], parts[10][1]), (0, 165, 255), 2)
    else:
